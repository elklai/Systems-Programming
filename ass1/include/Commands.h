...
public:
    ...
    static vector<string> dividePath(string a);//make a vector of BaseFile names
    static Directory& chekAndGoTo(FileSystem & fs,vector <string> vec);//return a referance to the Directory in the path
    virtual ~BaseCommand();
    };
